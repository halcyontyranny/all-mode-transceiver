...
class HackRFMultiModeTransceiver(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "HackRFMultiModeTransceiver")
...
def main(top_block_cls=HackRFMultiModeTransceiver, options=None):
